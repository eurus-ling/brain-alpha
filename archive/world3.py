...
count = 0 # how many alpha is runned

# 从第6个元素开始迭代alpha_list
#121+1150++1362+336+1543
for alpha in alpha_list[4512:]:
    ...
    while keep_trying:
        try:
            ...
            count = count + 1
            logging.info(f'Alpha location is: {sim_progress_url}. Total count is {count}.')  # 记录位置
            print(f'Alpha location is: {sim_progress_url}. Total count is {count}')  # 打印位置
